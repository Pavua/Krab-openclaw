...
- Время: `2026-02-24T22:11:44.034032+01:00`
...
│ Update          │ pnpm · npm latest 2026.2.23                                                                       │
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 38ms · auth token · MacBook-Pro-        │
│                 │ Pablito.local (192.168.0.171) app 2026.2.23 macos 26.4                                            │
│ Gateway service │ LaunchAgent installed · loaded · running (pid 73862, state active)                                │
│ Node service    │ LaunchAgent not installed                                                                         │
│ Agents          │ 1 · no bootstrap files · sessions 1389 · default main active 8m ago                               │
│ Memory          │ 2 files · 2 chunks · sources memory · plugin memory-core · vector ready · fts ready · cache on    │
│                 │ (2)                                                                                               │
│ Probes          │ skipped (use --deep)                                                                              │
│ Events          │ none                                                                                              │
│ Heartbeat       │ 30m (main)                                                                                        │
│ Sessions        │ 1389 active · default local (20k ctx) · ~/.openclaw/agents/main/sessions/sessions.json            │
└─────────────────┴───────────────────────────────────────────────────────────────────────────────────────────────────┘
...
├────────────────────────────────────────────────────────────────┼────────┼─────────┼──────────────┼──────────────────┤
│ agent:main:openai:87940ddf-29c2…                               │ direct │ 8m ago  │ local        │ unknown/20k (?%) │
│ agent:main:openai:ba6d5d2c-a129…                               │ direct │ 8m ago  │ local        │ unknown/20k (?%) │
│ agent:main:openai:cc3d2a8a-6b6f…                               │ direct │ 8m ago  │ local        │ unknown/20k (?%) │
│ agent:main:openai:decc8f70-55c4…                               │ direct │ 13m ago │ local        │ unknown/20k (?%) │
│ agent:main:openai:4dab30aa-d951…                               │ direct │ 13m ago │ local        │ unknown/20k (?%) │
│ agent:main:openai:e0ae8428-0c5e…                               │ direct │ 13m ago │ local        │ 17k/20k (86%)    │
│ agent:main:openai:4e17a5b4-c35b…                               │ direct │ 13m ago │ local        │ unknown/20k (?%) │
│ agent:main:openai:c7f69ca6-3090…                               │ direct │ 28m ago │ local        │ unknown/20k (?%) │
│ agent:main:openai:50a32493-fd78…                               │ direct │ 28m ago │ local        │ unknown/20k (?%) │
│ agent:main:openai:1237d249-5749…                               │ direct │ 28m ago │ local        │ unknown/20k (?%) │
└────────────────────────────────────────────────────────────────┴────────┴─────────┴──────────────┴──────────────────┘

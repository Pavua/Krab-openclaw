...
- источник: `/Users/pablito/Antigravity_AGENTS/Краб/docs/MASTER_PLAN_VNEXT_RU.md`
- правило расчёта: `/Users/pablito/Antigravity_AGENTS/Краб/docs/handoff/MASTER_PLAN_SOURCE_OF_TRUTH.md`

Для multi-account работы shared только repo/docs/artifacts.
`~/.openclaw`, auth и browser state никогда не считать общими между учётками.
Правила владения shared path и права записи брать из
...
Перед передачей работы на другую учётку сначала запускать

...
USERBOT_KNOWN_COMMANDS: frozenset[str] = frozenset(
    {
        ...
        "archive",
        "unarchive",
        # Wave 29-GG: команды, зарегистрированные в bridge но отсутствовавшие во frozenset
        "health",
        "debug",
        "notify",
        "id",
        ...
        "backup",
        "eval",
        # Wave 31: команды, добавленные в W21-W30 но не зарегистрированные в ACL
        "proactivity",
        "e2e-smoke",
        "models",
        "forget",
        ...
        "dreaming",  # dreaming.handle_dreaming (Wave 44-N-cli — OpenClaw Dreaming RPC)

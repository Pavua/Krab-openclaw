...
# _CONFIG_GROUPS / _CONFIG_KEY_DESC / _render_config_value / _render_config_all /
# handle_config + _SET_ALIASES / _SET_FRIENDLY / _get_set_value / _render_all_settings /
# handle_set + handle_acl + handle_scope + handle_reasoning + handle_role + handle_notify +
# _render_chat_ban_entries + handle_chatban + handle_cmdblock + handle_cmdunblock + handle_blocklist
# — extracted to commands/admin_commands.py (Phase 2 Wave 11, Session 27). Re-exported above.

...
Отвечает за транскрибацию аудио и анализ изображений.
Умеет конвертировать HEIC -> JPG на лету.
"""

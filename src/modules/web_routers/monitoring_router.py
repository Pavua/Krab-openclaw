# -*- coding: utf-8 -*-
"""
Monitoring router — Phase 2 Wave E extraction (Session 25).

Stateless GET endpoints для observability/monitoring/diagnostics, использующие
только module-level singletons (`metrics`, `timeline`) и core sub-modules.
Не требуют RouterContext/deps — pure functions, идеальные для extraction.

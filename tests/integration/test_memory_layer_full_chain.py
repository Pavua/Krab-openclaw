...
def _build_archive(path: Path) -> sqlite3.Connection:
    ...
    chunks = [
        (
            ...
            1,
            45,
            "Krab install via git clone and pip install",
        ),
        (
            "c2",
            "100",
            ...
            1,
            42,
            "Krab работает на Python 3.13 с pyrofork",
        ),
        (
            "c3",
            "100",
            ...
            1,
            45,
            "OpenClaw Gateway слушает на порту 18789",
        ),
        (
            "c4",
            "100",
            ...
            1,
            46,
            "Memory Layer Phase 2 — Model2Vec + sqlite-vec",
        ),
        (
            "c5",
            "100",
            ...
            1,
            35,
            "Совершенно случайный текст про погоду",
        ),
    ]

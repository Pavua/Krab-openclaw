...
- [x] **Почистить owner inbox**: stale open owner_request `10848/10897` закрыты через reusable `scripts/cleanup_old_inbox_items.py`, `api/health/lite` после TTL-кеша показывает уже `pending_owner_requests=2`, а не `4`

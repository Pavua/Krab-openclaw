...
**Статус:** 🚧 В РАЗРАБОТКЕ (R18, 2026-04-04) — базовая инфраструктура готова:
...
- Команды в Telegram: `!swarm traders <тема>`, `!swarm coders <тема>`, `!swarm teams`, `!swarm <команда> loop N <тема>`

**Следующий шаг:** Персистентная память агентов между сессиями + автономный запуск по расписанию.
